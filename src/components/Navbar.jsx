      ...
      <div className='flex items-center gap-4'>
        {
            ...
            <div className='flex items-center cursor-pointer group relative gap-2' onClick={()=>setDropDown(prev => !prev)}>
                ...
                {dropDown&&<div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden md:group-hover:block'>
        ...
        <div className={`${showMenu?'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
            ...
            <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
                ...
                <NavLink onClick={()=>setShowMenu(false)} to='/doctors/all'><p className='px-4 py-2 rounded inline-block'>All Doctors</p></NavLink>
